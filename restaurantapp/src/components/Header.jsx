          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                ...
                <p className="px-4 py-2 flex items-center cursor-pointer gap-3
                 hover:bg-slate-100 translate-all duration-100 
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p className="m-2 p-2  rounded-md shadow-md
                flex justify-center  items-center 
                cursor-pointer gap-3 hover:bg-gray-300
                 bg-gray-200 translate-all duration-100 
                 ease-in-out text-textColor text-base"
                 onClick={logout}
                 >
                Logout <MdLogout />
